...
const validarFormulario = (event) => {
    ...
    const terminos=document.querySelector("#terms");
    ...
    if(!direccion.value.trim()){
        // alert("Los campos Nombre, Apellido, Email y Password son obligatorios")
        document.querySelector("#error-direccion").textContent='Debe completar el campo Direccion';
        lastname.classList.add('error')
        validation=false;
    }
    ...
    if (terminos.checked == false) {
        document.querySelector("#error-terms").textContent='Debe aceptar los terminos';
        validation=false;
    }
